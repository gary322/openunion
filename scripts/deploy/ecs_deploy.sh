...
WORKER_SERVICES="${WORKER_SERVICES:-${PREFIX}-outbox,${PREFIX}-verification,${PREFIX}-payout,${PREFIX}-scanner,${PREFIX}-retention,${PREFIX}-github-ingest,${PREFIX}-alarm_inbox,${PREFIX}-ops-metrics}"
...
OPTIONAL_SERVICES="${OPTIONAL_SERVICES:-${PREFIX}-github-ingest,${PREFIX}-alarm_inbox,${PREFIX}-ops-metrics}"
